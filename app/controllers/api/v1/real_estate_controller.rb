class Api::V1::RealEstateController < ApplicationController
  ...
  def around_all_by_areas
    ...
    items0 = RealEstate.select("id, estate_group, date_buy, address, estate_type, building_type, date_built, buy_layer, building_total_layer, building_exchange_area, buy_total_price, buy_per_square_feet, building_room, building_sitting_room, building_rest_room, is_guarding, x_lat, y_long").where("x_lat IS NOT NULL and y_long IS NOT NULL #{showSaleQueryString} #{showRentQueryString} #{showPreSaleQueryString} #{salePerSquareQueryString} #{saleTotalQueryString} #{saleAreaQueryString} #{border0}" ).paginate(:page => 1, :per_page => 10)
    items1 = RealEstate.select("id, estate_group, date_buy, address, estate_type, building_type, date_built, buy_layer, building_total_layer, building_exchange_area, buy_total_price, buy_per_square_feet, building_room, building_sitting_room, building_rest_room, is_guarding, x_lat, y_long").where("x_lat IS NOT NULL and y_long IS NOT NULL #{showSaleQueryString} #{showRentQueryString} #{showPreSaleQueryString} #{salePerSquareQueryString} #{saleTotalQueryString} #{saleAreaQueryString} #{border1}" ).paginate(:page => 1, :per_page => 10)
    items2 = RealEstate.select("id, estate_group, date_buy, address, estate_type, building_type, date_built, buy_layer, building_total_layer, building_exchange_area, buy_total_price, buy_per_square_feet, building_room, building_sitting_room, building_rest_room, is_guarding, x_lat, y_long").where("x_lat IS NOT NULL and y_long IS NOT NULL #{showSaleQueryString} #{showRentQueryString} #{showPreSaleQueryString} #{salePerSquareQueryString} #{saleTotalQueryString} #{saleAreaQueryString} #{border2}" ).paginate(:page => 1, :per_page => 10)
    items3 = RealEstate.select("id, estate_group, date_buy, address, estate_type, building_type, date_built, buy_layer, building_total_layer, building_exchange_area, buy_total_price, buy_per_square_feet, building_room, building_sitting_room, building_rest_room, is_guarding, x_lat, y_long").where("x_lat IS NOT NULL and y_long IS NOT NULL #{showSaleQueryString} #{showRentQueryString} #{showPreSaleQueryString} #{salePerSquareQueryString} #{saleTotalQueryString} #{saleAreaQueryString} #{border3}" ).paginate(:page => 1, :per_page => 10)
    items4 = RealEstate.select("id, estate_group, date_buy, address, estate_type, building_type, date_built, buy_layer, building_total_layer, building_exchange_area, buy_total_price, buy_per_square_feet, building_room, building_sitting_room, building_rest_room, is_guarding, x_lat, y_long").where("x_lat IS NOT NULL and y_long IS NOT NULL #{showSaleQueryString} #{showRentQueryString} #{showPreSaleQueryString} #{salePerSquareQueryString} #{saleTotalQueryString} #{saleAreaQueryString} #{border4}" ).paginate(:page => 1, :per_page => 10)
    items5 = RealEstate.select("id, estate_group, date_buy, address, estate_type, building_type, date_built, buy_layer, building_total_layer, building_exchange_area, buy_total_price, buy_per_square_feet, building_room, building_sitting_room, building_rest_room, is_guarding, x_lat, y_long").where("x_lat IS NOT NULL and y_long IS NOT NULL #{showSaleQueryString} #{showRentQueryString} #{showPreSaleQueryString} #{salePerSquareQueryString} #{saleTotalQueryString} #{saleAreaQueryString} #{border5}" ).paginate(:page => 1, :per_page => 10)
    items6 = RealEstate.select("id, estate_group, date_buy, address, estate_type, building_type, date_built, buy_layer, building_total_layer, building_exchange_area, buy_total_price, buy_per_square_feet, building_room, building_sitting_room, building_rest_room, is_guarding, x_lat, y_long").where("x_lat IS NOT NULL and y_long IS NOT NULL #{showSaleQueryString} #{showRentQueryString} #{showPreSaleQueryString} #{salePerSquareQueryString} #{saleTotalQueryString} #{saleAreaQueryString} #{border6}" ).paginate(:page => 1, :per_page => 10)
    items7 = RealEstate.select("id, estate_group, date_buy, address, estate_type, building_type, date_built, buy_layer, building_total_layer, building_exchange_area, buy_total_price, buy_per_square_feet, building_room, building_sitting_room, building_rest_room, is_guarding, x_lat, y_long").where("x_lat IS NOT NULL and y_long IS NOT NULL #{showSaleQueryString} #{showRentQueryString} #{showPreSaleQueryString} #{salePerSquareQueryString} #{saleTotalQueryString} #{saleAreaQueryString} #{border7}" ).paginate(:page => 1, :per_page => 10)
    items8 = RealEstate.select("id, estate_group, date_buy, address, estate_type, building_type, date_built, buy_layer, building_total_layer, building_exchange_area, buy_total_price, buy_per_square_feet, building_room, building_sitting_room, building_rest_room, is_guarding, x_lat, y_long").where("x_lat IS NOT NULL and y_long IS NOT NULL #{showSaleQueryString} #{showRentQueryString} #{showPreSaleQueryString} #{salePerSquareQueryString} #{saleTotalQueryString} #{saleAreaQueryString} #{border8}" ).paginate(:page => 1, :per_page => 10)

    # for test return speed
    # items0 = RealEstate.select("x_lat, y_long").where("x_lat IS NOT NULL and y_long IS NOT NULL #{showSaleQueryString} #{showRentQueryString} #{showPreSaleQueryString} #{salePerSquareQueryString} #{saleTotalQueryString} #{saleAreaQueryString} #{border0}" ).limit(10)
    # items1 = RealEstate.select("x_lat, y_long").where("x_lat IS NOT NULL and y_long IS NOT NULL #{showSaleQueryString} #{showRentQueryString} #{showPreSaleQueryString} #{salePerSquareQueryString} #{saleTotalQueryString} #{saleAreaQueryString} #{border1}" ).limit(10)
    # items2 = RealEstate.select("x_lat, y_long").where("x_lat IS NOT NULL and y_long IS NOT NULL #{showSaleQueryString} #{showRentQueryString} #{showPreSaleQueryString} #{salePerSquareQueryString} #{saleTotalQueryString} #{saleAreaQueryString} #{border2}" ).limit(10)
    # items3 = RealEstate.select("x_lat, y_long").where("x_lat IS NOT NULL and y_long IS NOT NULL #{showSaleQueryString} #{showRentQueryString} #{showPreSaleQueryString} #{salePerSquareQueryString} #{saleTotalQueryString} #{saleAreaQueryString} #{border3}" ).limit(10)
    # items4 = RealEstate.select("x_lat, y_long").where("x_lat IS NOT NULL and y_long IS NOT NULL #{showSaleQueryString} #{showRentQueryString} #{showPreSaleQueryString} #{salePerSquareQueryString} #{saleTotalQueryString} #{saleAreaQueryString} #{border4}" ).limit(10)
    # items5 = RealEstate.select("x_lat, y_long").where("x_lat IS NOT NULL and y_long IS NOT NULL #{showSaleQueryString} #{showRentQueryString} #{showPreSaleQueryString} #{salePerSquareQueryString} #{saleTotalQueryString} #{saleAreaQueryString} #{border5}" ).limit(10)
    # items6 = RealEstate.select("x_lat, y_long").where("x_lat IS NOT NULL and y_long IS NOT NULL #{showSaleQueryString} #{showRentQueryString} #{showPreSaleQueryString} #{salePerSquareQueryString} #{saleTotalQueryString} #{saleAreaQueryString} #{border6}" ).limit(10)
    # items7 = RealEstate.select("x_lat, y_long").where("x_lat IS NOT NULL and y_long IS NOT NULL #{showSaleQueryString} #{showRentQueryString} #{showPreSaleQueryString} #{salePerSquareQueryString} #{saleTotalQueryString} #{saleAreaQueryString} #{border7}" ).limit(10)
    # items8 = RealEstate.select("x_lat, y_long").where("x_lat IS NOT NULL and y_long IS NOT NULL #{showSaleQueryString} #{showRentQueryString} #{showPreSaleQueryString} #{salePerSquareQueryString} #{saleTotalQueryString} #{saleAreaQueryString} #{border8}" ).limit(10)
  ...
  def get_estate_item
    estate_id = params[:estate_id].to_i
    item = RealEstate.find(estate_id)
    render :json => item
  end

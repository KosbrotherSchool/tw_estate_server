class Api::V1::RealEstateController < ApplicationController
  ...
  def around_all_by_areas
    ...
    items0 = RealEstate.select("x_lat, y_long").where("x_lat IS NOT NULL and y_long IS NOT NULL #{showSaleQueryString} #{showRentQueryString} #{showPreSaleQueryString} #{salePerSquareQueryString} #{saleTotalQueryString} #{saleAreaQueryString} #{border0}" ).paginate(:page => 1, :per_page => 10)
    items1 = RealEstate.select("x_lat, y_long").where("x_lat IS NOT NULL and y_long IS NOT NULL #{showSaleQueryString} #{showRentQueryString} #{showPreSaleQueryString} #{salePerSquareQueryString} #{saleTotalQueryString} #{saleAreaQueryString} #{border1}" ).paginate(:page => 1, :per_page => 10)
    items2 = RealEstate.select("x_lat, y_long").where("x_lat IS NOT NULL and y_long IS NOT NULL #{showSaleQueryString} #{showRentQueryString} #{showPreSaleQueryString} #{salePerSquareQueryString} #{saleTotalQueryString} #{saleAreaQueryString} #{border2}" ).paginate(:page => 1, :per_page => 10)
    items3 = RealEstate.select("x_lat, y_long").where("x_lat IS NOT NULL and y_long IS NOT NULL #{showSaleQueryString} #{showRentQueryString} #{showPreSaleQueryString} #{salePerSquareQueryString} #{saleTotalQueryString} #{saleAreaQueryString} #{border3}" ).paginate(:page => 1, :per_page => 10)
    items4 = RealEstate.select("x_lat, y_long").where("x_lat IS NOT NULL and y_long IS NOT NULL #{showSaleQueryString} #{showRentQueryString} #{showPreSaleQueryString} #{salePerSquareQueryString} #{saleTotalQueryString} #{saleAreaQueryString} #{border4}" ).paginate(:page => 1, :per_page => 10)
    items5 = RealEstate.select("x_lat, y_long").where("x_lat IS NOT NULL and y_long IS NOT NULL #{showSaleQueryString} #{showRentQueryString} #{showPreSaleQueryString} #{salePerSquareQueryString} #{saleTotalQueryString} #{saleAreaQueryString} #{border5}" ).paginate(:page => 1, :per_page => 10)
    items6 = RealEstate.select("x_lat, y_long").where("x_lat IS NOT NULL and y_long IS NOT NULL #{showSaleQueryString} #{showRentQueryString} #{showPreSaleQueryString} #{salePerSquareQueryString} #{saleTotalQueryString} #{saleAreaQueryString} #{border6}" ).paginate(:page => 1, :per_page => 10)
    items7 = RealEstate.select("x_lat, y_long").where("x_lat IS NOT NULL and y_long IS NOT NULL #{showSaleQueryString} #{showRentQueryString} #{showPreSaleQueryString} #{salePerSquareQueryString} #{saleTotalQueryString} #{saleAreaQueryString} #{border7}" ).paginate(:page => 1, :per_page => 10)
    items8 = RealEstate.select("x_lat, y_long").where("x_lat IS NOT NULL and y_long IS NOT NULL #{showSaleQueryString} #{showRentQueryString} #{showPreSaleQueryString} #{salePerSquareQueryString} #{saleTotalQueryString} #{saleAreaQueryString} #{border8}" ).paginate(:page => 1, :per_page => 10)
